...
from model.MCINet import MCINet
...
if __name__ == '__main__':
    ...
    model = MCINet(args.backbone, args.feature_extractor_path, False, original=args.original, cross_mix=args.cross_mix, add_4dconv=args.add_4dconv, 
                use_aspp=args.use_aspp, upmix=args.upmix,skip_mode=args.skip_mode, pooling_mix=args.pooling_mix, use_convnext=args.use_convnext, 
