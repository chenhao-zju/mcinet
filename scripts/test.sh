...
LOG_MODEL="./model/mcinet/log/${NAME}/"

visualize_path="./mcinet_visualize/standard_fss_vis/vis_1/"
...
CUDA_VISIBLE_DEVICES=5 .python ./test.py --datapath "./data/" \
            ...
            --nworker 20 \
            --backbone ${BACKBONE} \
            --feature_extractor_path "./model/mcinet/resnet50_a1h-35c100f8.pth" \
            --logpath ${LOG_MODEL} \
            --lr ${lr} \
            --weight ${WEIGHT} \
            --original True \
            ...
            --load "./model/mcinet/our_model/standard/fss/fss_resnet50/train/fold_0_0111_213127/best_model.pt" \
            --nshot ${SHOT} \
